...
python -m cam_to_midi --mapper ml
```
...
# With coverage
python -m pytest tests/ --cov=cam_to_midi
```
...
1. Create `src/cam_to_midi/sources/my_source.py` subclassing `BaseSource`
